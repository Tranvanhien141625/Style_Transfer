# -*- coding: utf-8 -*-
"""Style_Transfer_Solution_fix.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Z7hI7WudzptfaVPt-mPTvRMt-X-ODi_N
...
content = load_image('/content/XYZ.JPG').to(device)
# Resize style to match content, makes code easier
style = load_image('/content/XYZ3.JPG', shape=content.shape[-2:]).to(device)
...
steps = 40000  # decide how many iterations to update your image (5000)
...
for ii in range(1, steps+1):
    ...
    for layer in style_weights:
        ...
        layer_style_loss = style_weights[layer] * torch.sqrt(torch.mean((target_gram - style_gram)**2))
